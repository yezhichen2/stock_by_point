...
class ZB(object):
    ...
    @classmethod
    def mdi(cls, stock_data, n=14, m=6, d=6):
        """
        ...
        XPDI = df_tmp["PDI"].ewm(com=2).mean()
        XMDI = df_tmp["MDI"].ewm(com=2).mean()

        df_tmp["DIFF"] = (XPDI - XMDI).ewm(com=d).mean()

        return df_tmp.loc[:, ['PDI', 'MDI', 'ADX', 'ADXR', "DIFF"]]

    @classmethod
    def macd(cls, stock_data, short=12, long=26, m=9):
    ...
    @classmethod
    def ma(cls, stock_data, m1=5, m2=10, m3=20, m4=50):
        """
        MA1:MA(CLOSE,M1);
        MA2:MA(CLOSE,M2);
        MA3:MA(CLOSE,M3);
    ...
    @classmethod
    def vol(cls, stock_data, m1=3, m2=5, m3=10, m4=20):
        """
        :param stock_data:
        :return:
        """
